...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7408", "::ffff:127.0.0.1", 7408));
    BOOST_CHECK(TestSplitHost("[::]:7408", "::", 7408));
    BOOST_CHECK(TestSplitHost("::7408", "::7408", -1));
    BOOST_CHECK(TestSplitHost(":7408", "", 7408));
    BOOST_CHECK(TestSplitHost("[]:7408", "", 7408));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7408", "127.0.0.1:7408"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7408", "[::]:7408"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
