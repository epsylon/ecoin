...
public:
    ...
    void retranslateUi(QFrame *SendMessagesEntry)
    {
        ...
        sendTo->setToolTip(QApplication::translate("SendMessagesEntry", "The address to send the payment to  (e.g. EgAiyRYKKsQEDsbkYuML9d48WUm5DMTdAw)", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
