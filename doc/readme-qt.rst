...
Alternatively, install `Qt Creator`_ and open the `ecoin-qt.pro` file.
...
The static binary version of Ecoin is linked against libdb4.8 (see also `this Debian issue`_).
