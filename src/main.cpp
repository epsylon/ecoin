...
uint256 hashGenesisBlock("0x6cb0a1e3b850406960156f626649f753c19fe5cab60df52eed4b6c8d09e8d3d9");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Ecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Ecoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Ecoin: 2.5 minutes
...
{
    // Ecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6cb0a1e3b850406960156f626649f753c19fe5cab60df52eed4b6c8d09e8d3d9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1397482290;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4951267;
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Ecoin: increase each by adding 2 to bitcoin's value.
